...
<template>
  ...
  <div v-if="state===1" class="flex justify-center items-center py-4">
    <div class="grid grid-cols-12 gap-3 xl:w-2/3">
      <RouterLink v-for="move in moveArray" :to="'Moves/'+move.name" class="col-span-6 md:col-span-4 xl:col-span-3 2xl:col-span-2 rounded-xl shadow-lg border-2 border-bg2 bg-bg1 p-2 text-lg underline hover:text-hover hover:border-hover hover:shadow-2xl hover:scale-105">
